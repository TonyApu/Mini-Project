...
public class TransferenceService {
    ...
    @Autowired
    public TransferenceService(TransferenceRepository transferenceRepository, ReminderRepository reminderRepository, BookRepository bookRepository, MemberRepository memberRepository, ReminderService reminderService, NotificationService notificationService) {
