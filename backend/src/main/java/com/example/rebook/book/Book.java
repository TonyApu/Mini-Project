...
public class Book {
    ...
    public Book(String name, String author, String publisher, String language, Integer pageNum, Integer price, Integer quality, Member member, Category category) {
        this.name = name;
        this.author = author;
    ...
    public Book(String name, String author, String frontSideImage, String backSideImage, String totalImage, String publisher, String language, Integer pageNum, Integer price, Integer quality, Boolean transferStatus, Member member, Category category) {
        this.name = name;
        this.author = author;
