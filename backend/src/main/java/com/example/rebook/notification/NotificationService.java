...
public class NotificationService {
    ...
    public void newRequestStatusNotification(Long transferenceId, boolean status) {
        ...
        Member fromMember = transference.getFromBook().getMember();
        Member toMember = transference.getToBook().getMember();
        RequestNotification requestNotification = new RequestNotification(savedNotification, fromMember, toMember, status);
        requestNotificationRepository.save(requestNotification);
    }
