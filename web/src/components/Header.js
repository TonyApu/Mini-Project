          ...
          <Toolbar variant="dense">
            <Box display="flex" flexDirection="row" width="100%">
              ...
              <MenuIcon />
                ...
                <Typography variant="h6" style={{ fontWeight: 600, fontFamily: 'Merienda', marginLeft: '1.2rem' }}>ShareBook</Typography>
              </Box>
              <Box flexGrow={1}>
                <Grid alignItems="center" container>
                  ...
                  <Grid item>
                    ...
                    >
                      <MenuItem style={{ color: "#7a2e19" }} onClick={() => setAnchorEl(null)}>
                        <AiFillProfile />
